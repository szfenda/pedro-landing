                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                        ...
                        <a
                            ...
                            className="btn-brutal bg-black text-white border-3 border-white rounded-button px-8 py-4 flex items-center justify-center gap-3 min-h-[52px] shadow-brutal-lime hover:shadow-brutal-lime hover:-translate-y-2 active:scale-95 transition-all duration-300 relative overflow-hidden"
                        >
